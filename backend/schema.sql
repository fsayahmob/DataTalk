...
-- LLM Providers
INSERT INTO llm_providers (id, name, display_name, type, base_url, requires_api_key, is_enabled, created_at)
VALUES
    (6, 'google', 'Google AI', 'cloud', NULL, TRUE, TRUE, '2026-01-11 15:21:08'),
    (7, 'openai', 'OpenAI', 'cloud', NULL, TRUE, TRUE, '2026-01-11 15:21:08'),
    (8, 'anthropic', 'Anthropic', 'cloud', NULL, TRUE, TRUE, '2026-01-11 15:21:08'),
    (9, 'mistral', 'Mistral AI', 'cloud', NULL, TRUE, TRUE, '2026-01-11 15:21:08'),
    (10, 'ollama', 'Ollama', 'self-hosted', NULL, FALSE, TRUE, '2026-01-11 15:21:08'),
    (11, 'bedrock', 'AWS Bedrock', 'cloud', NULL, FALSE, TRUE, '2026-01-22 00:00:00')
ON CONFLICT (id) DO NOTHING;

-- Reset sequence for providers
SELECT setval('llm_providers_id_seq', (SELECT MAX(id) FROM llm_providers));

-- LLM Models
INSERT INTO llm_models (id, provider_id, model_id, display_name, supports_json_mode, supports_structured_output, context_window, cost_per_1m_input, cost_per_1m_output, is_default, is_enabled, created_at)
VALUES
    (12, 6, 'gemini-2.0-flash', 'Gemini 2.0 Flash', TRUE, TRUE, 1000000, 0.1, 0.4, FALSE, TRUE, '2026-01-11 15:21:08'),
    (13, 6, 'gemini-2.5-flash', 'Gemini 2.5 Flash', TRUE, TRUE, 1000000, 0.3, 2.5, TRUE, TRUE, '2026-01-11 15:21:08'),
    (14, 6, 'gemini-2.5-flash-lite', 'Gemini 2.5 Flash Lite', TRUE, TRUE, 1000000, 0.1, 0.4, FALSE, TRUE, '2026-01-11 15:21:08'),
    (15, 6, 'gemini-2.5-pro', 'Gemini 2.5 Pro', TRUE, TRUE, 1000000, 1.25, 10.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (16, 6, 'gemini-3-flash-preview', 'Gemini 3 Flash (Preview)', TRUE, TRUE, 1000000, 0.5, 3.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (17, 6, 'gemini-3-pro-preview', 'Gemini 3 Pro (Preview)', TRUE, TRUE, 1000000, 2.0, 12.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (18, 7, 'gpt-4o', 'GPT-4o', TRUE, TRUE, 128000, 2.5, 10.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (19, 7, 'gpt-4o-mini', 'GPT-4o Mini', TRUE, TRUE, 128000, 0.15, 0.6, FALSE, TRUE, '2026-01-11 15:21:08'),
    (20, 7, 'gpt-4.1', 'GPT-4.1', TRUE, TRUE, 1000000, 2.0, 8.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (21, 7, 'gpt-4.1-mini', 'GPT-4.1 Mini', TRUE, TRUE, 1000000, 0.4, 1.6, FALSE, TRUE, '2026-01-11 15:21:08'),
    (22, 7, 'o3-mini', 'o3 Mini (Reasoning)', TRUE, TRUE, 200000, 1.1, 4.4, FALSE, TRUE, '2026-01-11 15:21:08'),
    (23, 8, 'claude-sonnet-4-20250514', 'Claude Sonnet 4', TRUE, TRUE, 200000, 3.0, 15.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (24, 8, 'claude-3-5-haiku-20241022', 'Claude 3.5 Haiku', TRUE, TRUE, 200000, 0.8, 4.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (25, 8, 'claude-opus-4-20250514', 'Claude Opus 4', TRUE, TRUE, 200000, 15.0, 75.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (26, 9, 'mistral-large-latest', 'Mistral Large', TRUE, TRUE, 128000, 2.0, 6.0, FALSE, TRUE, '2026-01-11 15:21:08'),
    (27, 9, 'mistral-small-latest', 'Mistral Small', TRUE, TRUE, 128000, 0.2, 0.6, FALSE, TRUE, '2026-01-11 15:21:08'),
    (28, 9, 'codestral-latest', 'Codestral', TRUE, TRUE, 256000, 0.3, 0.9, FALSE, TRUE, '2026-01-11 15:21:08'),
    (29, 10, 'llama3.2', 'Llama 3.2 (Local)', TRUE, TRUE, 128000, NULL, NULL, FALSE, TRUE, '2026-01-11 15:21:08'),
    (30, 10, 'mistral', 'Mistral (Local)', TRUE, TRUE, 32000, NULL, NULL, FALSE, TRUE, '2026-01-11 15:21:08'),
    (31, 10, 'qwen2.5-coder', 'Qwen 2.5 Coder (Local)', TRUE, TRUE, 128000, NULL, NULL, FALSE, TRUE, '2026-01-11 15:21:08'),
    -- AWS Bedrock Models
    (32, 11, 'bedrock/anthropic.claude-3-5-sonnet-20241022-v2:0', 'Claude 3.5 Sonnet v2 (Bedrock)', TRUE, TRUE, 200000, 3.0, 15.0, FALSE, TRUE, '2026-01-22 00:00:00'),
    (33, 11, 'bedrock/anthropic.claude-3-5-haiku-20241022-v1:0', 'Claude 3.5 Haiku (Bedrock)', TRUE, TRUE, 200000, 0.8, 4.0, FALSE, TRUE, '2026-01-22 00:00:00'),
    (34, 11, 'bedrock/anthropic.claude-3-opus-20240229-v1:0', 'Claude 3 Opus (Bedrock)', TRUE, TRUE, 200000, 15.0, 75.0, FALSE, TRUE, '2026-01-22 00:00:00'),
    (35, 11, 'bedrock/amazon.titan-text-premier-v1:0', 'Amazon Titan Premier', TRUE, FALSE, 32000, 0.5, 1.5, FALSE, TRUE, '2026-01-22 00:00:00'),
    (36, 11, 'bedrock/meta.llama3-1-70b-instruct-v1:0', 'Llama 3.1 70B (Bedrock)', TRUE, FALSE, 128000, 0.99, 0.99, FALSE, TRUE, '2026-01-22 00:00:00'),
    (37, 11, 'bedrock/meta.llama3-1-8b-instruct-v1:0', 'Llama 3.1 8B (Bedrock)', TRUE, FALSE, 128000, 0.22, 0.22, FALSE, TRUE, '2026-01-22 00:00:00')
ON CONFLICT (id) DO NOTHING;
...
-- LLM Prompts
INSERT INTO llm_prompts (id, key, name, category, content, version, is_active, tokens_estimate, description, created_at, updated_at)
VALUES
    (9, 'analytics_system', 'Analytics System', 'analytics', 'Assistant analytique SQL. Réponds en français.
...
{"sql":"SELECT...","message":"Explication...","chart":{"type":"...","x":"col","y":"col|[cols]","title":"..."}}', 'v3', TRUE, 750, 'Prompt système pour l''analyse Text-to-SQL. V3: règle agrégation obligatoire.', '2026-01-17 00:11:14', '2026-01-17 00:11:14'),

    (3, 'catalog_enrichment', 'Catalog Enrichment', 'catalog', 'Tu es un expert en data catalog. Analyse cette structure de base de données et génère des descriptions sémantiques.
...
- Descriptions concises mais complètes', 'normal', TRUE, 200, 'Génération de descriptions sémantiques pour le catalogue. Placeholder {tables_context}.', '2026-01-11 18:56:07', '2026-01-11 22:38:21'),

    (7, 'catalog_questions', 'Génération Questions Suggérées', 'catalog', 'Analyse le schéma de données suivant et génère **8 questions métier pertinentes** que l''utilisateur pourrait poser.
...
Génère maintenant 8 questions variées et pertinentes pour ce schéma.', 'v1', TRUE, NULL, 'Génère des questions analytiques pertinentes basées sur le catalogue enrichi', '2026-01-12 19:04:48', '2026-01-12 20:53:56'),

    (6, 'widgets_generation', 'Widgets Generation', 'widgets', 'Tu es un analyste métier expert. Génère exactement 4 KPIs pour ce dashboard.
...
', 'normal', TRUE, 800, 'Génération des widgets et questions suggérées. Placeholder {schema}.', '2026-01-11 19:55:31', '2026-01-11 22:38:21')
ON CONFLICT (id) DO NOTHING;

-- Reset sequence for prompts
SELECT setval('llm_prompts_id_seq', (SELECT MAX(id) FROM llm_prompts));
